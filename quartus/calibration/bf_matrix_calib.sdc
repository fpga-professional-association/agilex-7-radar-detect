# ---------------------------------------------------------------------------
# bf_matrix_calib.sdc — timing constraints for the SPEC 18 beamforming-matrix calibration
# (issue #12).
#
...
# real system, but this wrapper ties cfg_clk to core_clk (see bf_matrix_wrap.sv), so the
