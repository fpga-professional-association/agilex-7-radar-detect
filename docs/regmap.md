...
- Blocks declared: 10 (9 implemented), registers implemented: 69
...
| `0x008` | `0x0008` | `GEOMETRY` | RO | `0x1020450A` | Shape of the register plane, so a discovery walk needs no compiled-in constants. |
...
| `15:8` | `N_REGS` | RO | `0x45` | — | Implemented registers across all blocks. |
